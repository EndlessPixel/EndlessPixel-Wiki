...
# 主世界维度升级
<p>主世界作为生存冒险的起点，本次数据包为主世界增加大量全新可探索建筑，搭配群系自适应生成逻辑，让平原、丛林、雪山等原生地形拥有更多值得探访的地标，丰富地面探索乐趣。</p>

## 🏰 多样化建筑结构
<div class="overworld-card">
<p>主世界新增了一批建筑结构，包括中世纪城堡、乡村小屋和神秘塔楼等类型。这些建筑外观各有特色，内部也藏了可探索的内容：城堡里有隐藏宝箱，塔楼里有机关谜题，乡村小屋附带 NPC 互动任务。</p>
</div>

## 🌄 环境融合设计
<div class="overworld-card">
<p>新增建筑会按所在生物群系的环境来生成，和原版地形自然衔接。雪山顶部会出现覆雪的石质城堡，丛林里藏着藤蔓缠绕的神秘塔楼，平原上则散布着乡村小屋。建筑的外观细节和内部布局会随群系的气候、地形变化，在不同环境里能见到不一样的样式。</p>
</div>
...
<div class="overworld-card">
<ul>
<li>已加载过的旧区块不会自动生成新建筑，想要找到新增结构，需要前往世界未加载的新区块探索。</li>
<li>建筑难度梯度区分：乡村小屋难度较低，适合前期探索；神秘塔楼与中世纪城堡怪物更强、谜题更多，推荐装备成型后再前往挑战。</li>
</ul>
</div>
